                 ...
                 w-full p-4 py-24 text-center space-y-10 relative z-10">
                    <div className="space-y-6">
                        <h1 className="text-5xl font-extrabold tracking-tight sm:text-7xl text-foreground drop-shadow-sm">
                            The creator economy platform for <br /> <span className="text-primary bg-primary/5 px-4 py-1 rounded-2xl border border-primary/10 backdrop-blur-sm">AI Agents</span>
                        </h1>
